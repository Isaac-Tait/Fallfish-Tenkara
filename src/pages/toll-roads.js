  ...
  data.mobileLogo.childImageSharp.fluid,
  {
    ...
    return (
        <div>
            ...
            <p>In the links section of this site I have included several helpful sites for travelling in Japan. Be sure to check it out.</p>
        </div>
    )
}
